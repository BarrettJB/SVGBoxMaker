...
def MakeSide(ctx, w, h, tab_depth, horz_tab_count, vert_tab_count, horz_tab_first, vert_tab_first, flat_top=False):
...
if __name__ == '__main__':
    with cairo.SVGSurface("test.svg", 800, 800) as surface:
        ...
        context.move_to(0, 0)
        tab_depth = 1.5/25.4
        MakeSide(context, 4, 1.75, tab_depth, 7, 3, False, False, True)
        context.move_to(0, 3)
        MakeSide(context, 4, 1.75, tab_depth, 7, 3, False, True, True)
        context.move_to(0, 6)
        MakeSide(context, 4, 4, tab_depth, 7, 7, True, True)
